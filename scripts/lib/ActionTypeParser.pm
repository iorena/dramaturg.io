...
sub generalize_action_type($action_type) {
    ...
    Convert::generalize_subject($action_type->{'subject'}) unless exists $action_type->{'subject_is_propn'};
    $action_type->{'verb'} = Convert::generalize_verb($action_type->{'verb'});
    Convert::generalize_object($action_type->{'object'}) unless exists $action_type->{'object_is_propn'};
}
